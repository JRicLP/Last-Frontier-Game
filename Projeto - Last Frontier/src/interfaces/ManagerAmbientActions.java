...
public interface ManagerAmbientActions {
    ...
    public abstract void mudarAmbiente(Personagem personagemAtual, Ambientes novoAmbiente); //Esse metodo recebe como parâmetros um objeto Personagem e um Ambiente
