...
public class EventoCriatura extends Eventos{
    ...
    public void gerarCriaturasIniciais() {
        EventoCriatura parasita=new EventoCriatura("Invasão Parasita", "Um parasita se prende ao personagem.", 0.7,
        ...
        EventoCriatura mumia=new EventoCriatura("Ataque de Múmia", "O personagem está no deserto e a múmia o ataca", 0.5,
        ...
        EventoCriatura yet=new EventoCriatura("Ataque de Yet", "O yet ataca o personagem nas montanhas geladas", 0.4,
        ...
        EventoCriatura sereia=new EventoCriatura("Sereia", "A sereia canta para o personagem quando ele estiver próximos de alguns rios", 0.6,
