...
public class EventoDoencaFerimento extends Evento {
    ...
    public void executar(Personagem personagemAfetado, Ambiente ambienteAtual) {
        ...
        switch (this.getNomeEvento()) {
            case "Sotnblár": // Mordida da Cobra -> tipoDoenca = "Envenenamento"
            ...
            case "Dróttarskör": // Chifrada do Javali -> tipoDoenca = "Corte"
            ...
            case "Skuggbrandr": // Contato com a Aranha -> tipoDoenca = "Feitiço"
            ...
            case "Húndraugr": // Arranhão do Lobo -> tipoDoenca = "Corte"
            ...
            case "Aldrgáta": // Olhar do Pássaro -> tipoDoenca = "Feitiço"
            ...
            case "Frostseidr": // Toque do Cervo -> tipoDoenca = "Corte e Feitiço"
