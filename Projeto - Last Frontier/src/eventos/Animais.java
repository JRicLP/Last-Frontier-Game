...
public class Animais extends EventoCriatura{
    ...
    public void gerarAnimais(){
        criarAnimalDinamico("Ataque de Lobo", "O lobo ataca o personagem em busca de comida", 0.8,
        ...
        criarAnimalDinamico("Ataque de Cobra","A cobra pica o personagem", 0.7,
        ...
        criarAnimalDinamico("Ataque de Corvos", " Os corvos ficam o rodeado e gerando alucinações",
                0.8, " Redução de sanidade", "Ocorre quando ele estiver nas montanhas",
                " Corvos Furtivos", 9, "Faz a sanidade diminuir 20 pontos ");

        criarAnimalDinamico("Surpresa de Serpente", "A serpente das areias podem picar rapidamente o personagem",
        ...
        criarAnimalDinamico("Aparição de Javali", "Os javalis vivem na florestam e servem de comida", 0.8,
        ...
        criarAnimalDinamico("Aparição de cervo", "O cervo aparece nas florestas para guiar o personagem em ambientes escuros", 0.9,
        ...
        criarAnimalDinamico("Aparição de Tartaruga ", "A tartaruga medicinal ajuda o personagem a encontrar ervas medicinais para antídotos",
